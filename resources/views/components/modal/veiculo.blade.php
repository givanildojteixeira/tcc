        ...
        <div class="mt-2 border-t pt-1 flex flex-wrap gap-2 justify-center">
            ...
            <template x-if="veiculo.origem === 'novos'">
                <div class="flex flex-wrap gap-2">
                    ...
                    <button @click="window.open(`/mev/precos.pdf`, '_blank')" title="Última tabela de preços divulgada"
...
{{-- mostrarToast() --}}
<div x-data="{ toast: null }" x-init="window.mostrarToast = (msg) => { toast = msg;
    setTimeout(() => toast = null, 3000); }" class="fixed top-4 right-4 z-50">
