        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            <div class="flex gap-2 whitespace-nowrap">
                <a href="{{ route('financeiro.index') }}"
                    ...
                    <i class="fas fa-arrow-circle-down"></i> Contas a Pagar
                </a>
                ...
                <a href="{{ route('financeiro.receber') }}"
                    ...
                    <i class="fas fa-arrow-circle-up"></i> Contas a Receber
                </a>
            </div>
                        ...
                        <td class="px-3 py-2 text-center">
                            @if (!$proposta->veiculo->pago)
                                <x-modal-question :acao="route('financeiro.pagar', $proposta->veiculo->id)" metodo="POST"
                                    ...
                                    mensagem="Deseja marcar este veículo como <strong>pago</strong>?" cor="green">
