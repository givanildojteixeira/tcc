<div x-data="{ showModalObservacao: false }">

    {{-- Cabeçalho com logo e título --}}
    <div class="flex items-center justify-between ">
        <div class="flex items-center space-x-4">
            <h1 class="text-2xl font-bold text-gray-800"> 📝 Proposta de Venda de Veículo Nro: <strong>{{
                    $proposta['id'] }}</strong> </h1>
        </div>
    </div>
        ...
        <div class="px-4 print:px-0 print:max-h-full print:overflow-visible max-h-[85vh] overflow-y-auto">
            ...
            <fieldset class="border border-green-400 bg-green-50 p-2 rounded-md shadow-sm mb-1">
                ...
                <ul class="text-sm text-gray-800">
                    <li>
                        ...
                        <strong>Valor Tabela:</strong> R$ {{ number_format($veiculo->vlr_tabela, 2, ',',
                        '.') }}
                    </li>
                </ul>
            </fieldset>
            ...
            <fieldset class="border border-green-400 bg-green-50 p-2 rounded-md shadow-sm mb-1">
                ...
                <div class="grid grid-cols-3 text-sm text-gray-800">
                    ...
                    <div><strong>Valor Avaliação:</strong> R$ {{ number_format($veiculoUsado->vlr_tabela, 2, ',',
                        '.') }}</div>
                </div>
            </fieldset>
            @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 items-stretch">
                    ...
                    <table class="w-full text-sm text-left border border-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 border text-right">R$ {{ number_format($n['valor'], 2,
                                    ',', '.') }}</td>
                ...
                <fieldset class="border border-green-400 bg-green-50 rounded-md px-4 py-2 bg-gray-50 h-full">
                    ...
                    <div class="text-sm text-gray-800 space-y-1">
                        ...
                        <div class="flex justify-between">
                            <span>Usado(s):</span>
                            <span>R$ {{ number_format($proposta['valor_veiculoUsado'] ?? 0, 2, ',', '.')
                                }}</span>
                        </div>
