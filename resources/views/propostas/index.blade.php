<x-app-layout>
    <div x-data="{
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4 px-4 py-4 bg-white shadow rounded-md border">
            ...
            <!-- Filtro -->
            <form method="GET" action="{{ route('propostas.index') }}" class="flex gap-2 w-full">
                <input type="text" name="busca" value="{{ request('busca') }}"
                    placeholder="Buscar por cliente, status ou veículo..."
                    ...
                    <table class="w-full table-fixed">
                        ...
                        @endforeach
                            ...
                            @if ($propostas->isEmpty())
                                <tr>
                                    <td colspan="5" class="px-4 py-4 text-center text-gray-500">Nenhuma proposta encontrada.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
