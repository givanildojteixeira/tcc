<div class="min-h-full flex flex-col gap-4 px-1 pb-24 pt-1 ">
    <div x-data="resumoProposta" x-init="carregaVeiculo();    carregaCliente();    carregaResumoFinanceiro();    carregaVeiculoUsado()" class="space-y-1">
        <!-- Resumo Cliente -->
