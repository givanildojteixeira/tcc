<div class="space-y-6">
    ...
    <div>
        ...
        <textarea name="observacao_nota" id="observacao_nota" rows="4"
            class="w-full border border-gray-300 rounded-md p-3 shadow-sm focus:ring-green-400 focus:outline-none"
            placeholder="Ex: Entrega programada para até 10 dias úteis, sujeito à análise financeira."></textarea>
    </div>
    ...
    <div>
        ...
        <textarea name="observacao_interna" id="observacao_interna" rows="4"
            class="w-full border border-gray-300 rounded-md p-3 shadow-sm focus:ring-green-400 focus:outline-none"
            placeholder="Ex: Cliente pediu reserva até sexta-feira, confirmação pendente da diretoria."></textarea>
    </div>
</div>
