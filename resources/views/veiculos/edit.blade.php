    ...
    {{-- <div x-data="{ tabAtiva: 'info' }" class="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-6"> --}}
        ...
        <div x-data="{
            tabAtiva: '{{ old('tabAtiva') ?? (
                $errors->has('cor') ? 'info' :
                ($errors->has('imagens') ? 'fotos' :
                ($errors->has('opcionais') ? 'opcionais' : 'info'))
            ) }}'
                        ...
                        <div class="flex flex-wrap gap-4 mb-4">
                            ...
                            <div class="flex-grow basis-[10%] min-w-[80px]">
                                ...
                                <select name="combustivel"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none">
                                    <option value="Gasolina" {{ old('combustivel', $veiculo->combustivel) ==
                                        'Gasolina' ?
                                        'selected' : '' }}>
                                        Gasolina
                                    </option>
                                    ...
                                    <option value="Flex" {{ old('combustivel', $veiculo->combustivel) == 'Flex' ?
                                        'selected'
                                        : '' }}>Flex
                                    </option>
                                </select>
                            ...
                            <div class="flex-grow basis-[14%] min-w-[100px]">
                                ...
                                <select name="transmissao"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none">
                                    <option value="Mecânica" {{ old('transmissao', $veiculo->transmissao) ==
                                        'Mecânica' ?
                                        'selected' : '' }}>
                                        Mecânica
                                    </option>
                                    <option value="Automática" {{ old('transmissao', $veiculo->transmissao) ==
                                        'Automática'
                                        ? 'selected' : '' }}>
                                        Automática
                                    </option>
                        ...
                        <div class="flex flex-row gap-4 mb-4 ">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="local" id="local" required
                                    ...
                                    <option value="Transito" {{ old('local', $veiculo->local) == 'Transito' ?
                                        'selected' :
                                        '' }}>Trânsito
                                    </option>
                                    @else
                                    ...
                                    <option value="Consignado" {{ old('local', $veiculo->local) == 'Consignado' ?
                                        'selected'
                                        : '' }}>
                                        Consignado</option>
                                    @endif
                ...
                <div x-show="tabAtiva === 'fotos'">
                    ...
                    <div class="border border-green-500 rounded-xl p-6 mb-6 shadow-sm bg-white">
                       ...
                       file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200">
                            ...
                            for ($i = 1; $i <= 10; $i++) { $nome="{$chassiBase}_" . str_pad($i, 2, '0' , STR_PAD_LEFT)
                                . '.jpg' ; if (file_exists(public_path("images/cars/$nome"))) {
                                $imagens[]=asset("images/cars/$nome"); } } @endphp @if (count($imagens)) <div
