            ...
            <div x-show="tabAtiva === 'info'">
                <div class="border border-green-500 rounded-xl p-6 mb-6 shadow-sm bg-white">
                        ...
                        <div class="flex-grow basis-[25%] min-w-[150px]">
                            ...
                            <select name="cor" required
                                ...
                                @foreach ($coresRelacionadas as $cor)
                                    <option value="{{ $cor->cor_desc }}"
                                        {{ strtolower($veiculo->cor) === strtolower($cor->cor_desc) ? 'selected' : '' }}>
                                        {{ $cor->cor_desc }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="flex flex-row gap-4 mb-4 ">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="local" id="local" required
                                ...
                                @if (request('from') === 'novos')
                                    <option value="Matriz"
                                        {{ old('local', $veiculo->local) == 'Matriz' ? 'selected' : '' }}>
                                        Matriz
                                    </option>
                                    <option value="Filial"
                                        {{ old('local', $veiculo->local) == 'Filial' ? 'selected' : '' }}>
                                        Filial
                                    </option>
                                    <option value="Transito"
                                        {{ old('local', $veiculo->local) == 'Transito' ? 'selected' : '' }}>
                                        Trânsito
                                    </option>
                                @else
                                    <option value="Matriz"
                    ...
                    $watch('promocao', val => {
                        ...
                        <div class="flex items-center gap-3">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" x-model="promocao" :disabled="!ativo"
                                    class="sr-only peer">
                                <div
