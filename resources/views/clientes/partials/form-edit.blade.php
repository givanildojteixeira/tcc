        ...
        <div x-data="{ tabAtiva: 'dados' }">
            ...
            <div class="h-[600px] flex flex-col justify-between">
                ...
                <div x-show="tabAtiva === 'dados'" class="grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
                    ...
                    <x-select label="Sexo" name="sexo" required  x-model="editData.sexo">
                        <option value="">Não Informado</option>
                        <option value="M">Masculino</option>
                        <option value="F">Feminino</option>
                        <option value="Outro">Outro</option>
                    </x-select>
                    <x-select label="Estado Civil" name="estado_civil"  required  x-model="editData.estado_civil">
                        <option value="">--</option>
                    ...
                    <x-input label="Data de Nascimento" name="data_nascimento" type="date"  required  x-model="editData.data_nascimento" />
